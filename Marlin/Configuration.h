...
#define STRING_CONFIG_H_AUTHOR "(wiloo, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR1.4 conf11"
...
//Ender 5 Bed Tuned for 60C
  #define DEFAULT_bedKp 134.01
  #define DEFAULT_bedKi 25.57
  #define DEFAULT_bedKd 468.14
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 95.92 }
...
//#define Z_AFTER_HOMING  200      // (mm) Height to move to after homing Z
